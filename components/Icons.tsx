...
export const DoveIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M12 21c-1.5-2-3-4-3-6s1.5-3 3-3 3 1 3 3-1.5 4-3 6z" />
    <path d="M12 15c-2-2-5-3-7-3-3 0-3 3-1 5 1 1 4 2 8 2" />
    <path d="M12 15c2-2 5-3 7-3 3 0 3 3 1 5-1 1-4 2-8 2" />
  </svg>
);

export const HandsIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <path d="M18 11v-5a2 2 0 0 0-4 0v2" />
    <path d="M14 10v-5a2 2 0 0 0-4 0v2" />
    <path d="M10 10.5v-5.5a2 2 0 0 0-4 0v2" />
    <path d="M6 11v-2a2 2 0 0 0-3 2v6a10 10 0 0 0 20 0v-6a2 2 0 0 0-3-2" />
  </svg>
);
...
export const FireIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" stroke="none" className={className}>
    <path d="M12 22c4.97 0 9-4.03 9-9 0-4.969-9-13-9-13S3 8.031 3 13c0 4.97 4.03 9 9 9z" opacity="0.5"/>
    <path d="M12 18c2.21 0 4-1.79 4-4 0-2.21-4-8-4-8s-4 5.79-4 8c0 2.21 1.79 4 4 4z" fill="currentColor"/>
  </svg>
);
...
export const SpeakerIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"></polyline>
...
export const GoogleIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className={className}>
    ...
    <path d="M12 4.36c1.61 0 3.06.56 4.21 1.64l3.16-3.16C17.45 1.04 14.97 0 12 0 7.7 0 3.99 2.47 2.18 7.07l3.66 2.84c.87-2.6 3.3-4.53 6.16-4.53z" fill="#EA4335"/>
  </svg>
);